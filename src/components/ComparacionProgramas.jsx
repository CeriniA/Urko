...
const ComparacionProgramas = () => {
  ...
  const features = [
    ...
    { name: 'Encuentros grupales en vivo', fundamental: false, trimestral: '6 encuentros', acompanado: false, individual: false },
    { name: 'Videollamadas grupales', fundamental: false, trimestral: false, acompanado: 'Semanales', individual: false },
